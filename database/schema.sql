...
CREATE TABLE clientes (
  ...
  saldo_actual      DECIMAL(14,4) NOT NULL DEFAULT 0.00 COMMENT 'USD',
...
CREATE TABLE creditos (
  ...
  saldo_usd                   DECIMAL(14,4) NOT NULL,
...
CREATE TABLE abonos (
  ...
  tasa_cambio_id     BIGINT UNSIGNED NULL,
  monto_usd          DECIMAL(14,4) NOT NULL COMMENT 'Equivalente USD que descuenta del saldo',
  monto_aplicado_usd DECIMAL(14,4) NOT NULL DEFAULT 0.00,
  saldo_a_favor_usd  DECIMAL(14,4) NOT NULL DEFAULT 0.00,
  referencia         VARCHAR(60) NULL,
  observaciones      VARCHAR(255) NULL,
  estado             ENUM('APLICADO','ANULADO') NOT NULL DEFAULT 'APLICADO',
  clave_idempotencia CHAR(36) NULL,
...
CREATE TABLE abono_aplicaciones (
  ...
  saldo_anterior_usd  DECIMAL(14,4) NOT NULL,
  saldo_posterior_usd DECIMAL(14,4) NOT NULL,
  creado_en           DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (id),
